var e=globalThis,t={},o={},s=e.parcelRequire1001;null==s&&((s=function(e){if(e in t)return t[e].exports;if(e in o){var s=o[e];delete o[e];var a={id:e,exports:{}};return t[e]=a,s.call(a.exports,a,a.exports),a.exports}var n=Error("Cannot find module '"+e+"'");throw n.code="MODULE_NOT_FOUND",n}).register=function(e,t){o[e]=t},e.parcelRequire1001=s),(0,s.register)("70IEE",function(e,t){console.log("Header script loaded successfully.")}),s("70IEE");const a=document.querySelector(".episodes-data"),n=document.querySelector(".episodes-button"),i=document.querySelector(".episodes-search-input"),d=document.getElementById("episodeSelect");let l=1,c=[],r=[];const p={1:"../../img/season-1.png",2:"../../img/season-2.png",3:"../../img/season-3.png",4:"../../img/season-4.png",5:"../../img/season-5.png",6:"../../img/season-6.png"};async function u(){try{let e=[],t=await fetch("https://rickandmortyapi.com/api/episode?page=1"),o=await t.json();o.results.forEach(t=>e.push(t));let s=o.info.pages;for(let t=2;t<=s;t++){let o=await fetch(`https://rickandmortyapi.com/api/episode?page=${t}`);(await o.json()).results.forEach(t=>e.push(t))}c=e,function(e){let t=e.reduce((e,t)=>{let o=`Season ${t.episode.slice(1,3)}`,s=t.episode.slice(4,6);return e[o]=(e[o]||[]).concat({id:t.id,name:`Episode ${s}`}),e},{});for(let e in d.innerHTML='<option value="">All episodes</option>',t){let o=document.createElement("option");o.value=e,o.textContent=`${e} (all)`,d.appendChild(o);let s=document.createElement("optgroup");s.label=e,t[e].forEach(e=>{let t=document.createElement("option");t.value=e.id,t.textContent=e.name,s.appendChild(t)}),d.appendChild(s)}}(c),m()}catch(e){console.error("Помилка завантаження епізодів:")}}function m(e=!0){e&&(a.innerHTML="",r=[],l=1);let t=function(){let e=i.value.toLowerCase(),t=d.value;return c.filter(o=>{let s=o.name.toLowerCase().includes(e),a=!0;if(t)if(t.startsWith("Season")){let e=t.split(" ")[1];a=o.episode.startsWith("S"+e.padStart(2,"0"))}else a=o.id==t;return s&&a})}(),o=(l-1)*8,s=8*l,u=t.slice(o,s);r=r.concat(u);let g=u.map(e=>{let t=parseInt(e.episode.slice(1,3),10),o=parseInt(e.episode.slice(4,6),10);return p[t],`
      <div data-modal-open 
