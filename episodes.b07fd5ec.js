function e(e,t,a,o){Object.defineProperty(e,t,{get:a,set:o,enumerable:!0,configurable:!0})}var t=globalThis,a={},o={},s=t.parcelRequire1001;null==s&&((s=function(e){if(e in a)return a[e].exports;if(e in o){var t=o[e];delete o[e];var s={id:e,exports:{}};return a[e]=s,t.call(s.exports,s,s.exports),s.exports}var n=Error("Cannot find module '"+e+"'");throw n.code="MODULE_NOT_FOUND",n}).register=function(e,t){o[e]=t},t.parcelRequire1001=s);var n=s.register;n("70IEE",function(e,t){var a=s("3j7nR");let o=document.querySelector(".header__form"),n=document.querySelector(".header__search-box"),i=document.querySelector(".header__error-text"),r=document.querySelector(".header__close-icon");r.addEventListener("click",()=>{n.style.display="none",n.style.visibility="hidden",r.style.display="none"});let l=window.location.pathname.includes("episodes.html");!0===window.location.pathname.includes("characters.html")||!0===l?(document.querySelector(".header__links").style.display="none",document.querySelector(".header__logo").style.visibility="visible",document.querySelector(".header__logo").style.display="block"):(document.querySelector(".header__links").style.display="flex",document.querySelector(".header__logo").style.visibility="hidden",document.querySelector(".header__logo").style.display="none"),console.log(o),o.addEventListener("submit",async e=>{e.preventDefault();let t=` 
    <p id="error-text">Oops! Try looking for something else...  </p>`;n.style.display="block",n.style.visibility="visible",i.style.display="none",i.style.visibility="hidden",r.style.display="block";let o=document.querySelector(".header__search").value.trim().toLowerCase();try{let e=l?a.getEpisodesList:a.getCharacterList,s=await e(1),r=s.info.pages,c=[];for(let t=2;t<=r;t++)c.push(e(t));let d=await Promise.all(c),p=[...s.results,...d.flatMap(e=>e.results)].filter(e=>e.name.toLowerCase().includes(o));n.addEventListener("click",e=>{console.log(e.target.innerHTML),p.map(t=>{if(l){if(`${t.episode} \u{2014} ${t.name}`===e.target.innerHTML){console.log(e.target.innerHTML);let a=`
          ...
          created: ${t.created}
          <br>
          `;n.innerHTML=a,console.log(a)}}else if(t.name===e.target.innerHTML){let e=`
...
//# sourceMappingURL=episodes.b07fd5ec.js.map
